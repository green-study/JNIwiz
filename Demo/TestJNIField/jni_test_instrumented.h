...
struct JNIEnv_ {
	...
	if(class_map.empty() && class_vector.empty()){
		class_vector.push_back("TestJNIField");
	}
	if(func_map.empty() && static_func_map.empty()){
		...
		func_map["TestJNIField"] = v;
		static_func_map["TestJNIField"] = sv;
		v.clear();
		sv.clear();
	}
	if(field_map.empty() && static_field_map.empty()){
		...
		f.push_back(make_pair("n", "I"));
		sf.push_back(make_pair("x", "Ljava/lang/String;"));
		field_map["TestJNIField"] = f;
		static_field_map["TestJNIField"] = sf;
		f.clear();
		sf.clear();
	}
    }    
