...
struct JNIEnv_ {
	...
	if(class_map.empty() && class_vector.empty()){
		class_vector.push_back("TestJNI");
	}
	if(func_map.empty() && static_func_map.empty()){
		...
		sv.push_back(make_pair("temp2", "(II)V"));
		sv.push_back(make_pair("registerNatives", "()V"));
		sv.push_back(make_pair("<clinit>", "()V"));
		func_map["TestJNI"] = v;
		static_func_map["TestJNI"] = sv;
		v.clear();
		sv.clear();
	}
	if(field_map.empty() && static_field_map.empty()){
		...
		f.push_back(make_pair("narr", "[I"));
		sf.push_back(make_pair("arr", "[I"));
		field_map["TestJNI"] = f;
		static_field_map["TestJNI"] = sf;
		f.clear();
		sf.clear();
	}
    }    
